...
#----- Starting Functions -----#
    ...
    def setup_topbar(self):
        self.home.topbar.columnconfigure(0, weight=2)

        self.currency_display = ctk.CTkLabel(self.home.topbar, height=75, width=125, text="Currency",
                                             font=self.config.card_font, fg_color=self.config.topbar_bg_color,
                                             bg_color=self.config.topbar_color, corner_radius=10)
        self.currency_display.grid(row=0, column=0, padx=10, sticky="ens")
