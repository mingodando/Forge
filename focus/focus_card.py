...
class FocusCard:
    ...
    def create_onboard(self):
        self.zero_label = ctk.CTkLabel(self.home_page.focus_frame, width=160, height=10, text="ZERO-FRICTION START", font=self.config.timer_font, text_color=self.config.amber, fg_color=self.config.nav_tab_color)
        self.zero_label.grid(row=0, column=1, sticky="n")
        ...
        self.focus_label.grid(row=1, column=1, sticky="s")
